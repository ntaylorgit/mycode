...
def main():
    ...
    # print 'Nikki Taylor' in yellow
    print(crayons.yellow('Nikki Taylor', bold=True))

    # print 'Nikki Taylor' in red and blue
    print(f"{crayons.red('Nikki')} {crayons.blue('Taylor')}")
